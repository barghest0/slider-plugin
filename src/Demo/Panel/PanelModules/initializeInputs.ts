...
const initializeInputs = function (this: Panel, root?: string) {
  ...
  this.decimalPlacesInput = panel!.querySelector('.js-input__decimal-places');
  ...
  this.hasScale = panel!.querySelector('.js-checkbox__scale');
  this.isDecimal = panel!.querySelector('.js-checkbox__decimal');
